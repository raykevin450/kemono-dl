...
class downloader:
    ...
    def __init__(self, args):
        ...
        self.title_filter = args['post_title_filter']
    ...
    def skip_post(self, post:dict):
        ...
        if not(self.check_substring_ignore_case(post['post_variables']['title'], self.title_filter)):
            logger.debug(f"Skipping post | title does not contain {self.title_filter}")
            return True
    ...
    def check_substring_ignore_case(self, string, substring):
